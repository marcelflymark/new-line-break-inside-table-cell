# Insert a new line within a table cell on mobile devices
## Purpose
Add a new line within the same table cell on mobile devices.
...
However, on mobile devices it is not possible to type the key combination SHIFT+ENTER. So this plugin adds a command to Obsidian that inserts a new line and moves the cursor to the next line within the same table cell. This adds the ability of typing multiple lines within the same table cell on devices that have no hardware keyboard to Obsidian.
## Usages
...
## Using the command to insert a newline on mobile devices
...
Command Palette name: **New Line Within Table Cell: New line**
..
